...
'=========================================
'APPEL USFCONNECT A L'OUVERTURE DU FICHIER
'=========================================
Sub auto_open()
   USFConnect.Show
...
'===============================
'APPEL CHOIX ANALYSE AVEC BTN GO
'===============================
Sub ChoixAnalyse()
   USFTypes.Show
End Sub
...
'==========================================
'SCRIPT DE CONNEXION AUX BASES ET REQUETAGE
'==========================================
...
Sub SSO()
   ...
   Temps_deb = Timer
   li_id = 2
   While Workbooks("DataExtract_V4.xlsm").Worksheets("Donnees_Entree").Cells(li_id, 1) <> ""
      li_id = li_id + 1
   Wend
   nb_li = li_id - 2
   comptMAX = nb_li * 9
   ...
   Dim Amb1$, Amb2$, DbSelect$, SampIDNa$
...
'   regex: objet regexp pour recherche de pattern
   ...
   With Workbooks("DataExtract_V4.xlsm")
      ...
      'Requete pour rechercher la base la plus récente parmis les bases selectionnées de la liste
